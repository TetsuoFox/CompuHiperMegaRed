    ...
    <asp:TextBox class="form-control" ID="txtNombreAlmacen" runat="server" placeholder="Bodega Stgo"  autopostback="true" ></asp:TextBox>
     ...
     <h2>Almacenes en el sistema</h2>
                  ...
                  <div class="col-sm-2">
                      ...
                      <div class="p-2">   <asp:Button  class="btn btn-dark" ID="btnActualizaTbl" runat="server"  Text="Actualizar Tabla" OnClick="btnActualizaTbl_Click"  />
                   </div>
                      <div class="p-2">      <asp:CheckBox class="form-check-input" ID="chkTraeActivos" runat="server" checked ="true" />
